...
- [1. docker容器更新](#1-docker容器更新)
  - [1.1. 手动更新](#11-手动更新)
  - [1.2. Watchtower自动更新](#12-watchtower自动更新)
    - [1.2.1. 快速开始](#121-快速开始)
    - [1.2.2. 选项参数](#122-选项参数)
    - [1.2.3. 自动清除旧镜像](#123-自动清除旧镜像)
    - [1.2.4. 选择性自动更新](#124-选择性自动更新)
    - [1.2.5. 容器更新列表](#125-容器更新列表)
    - [1.2.6. 设置单个容器自动更新特征](#126-设置单个容器自动更新特征)
    - [1.2.7. 设置自动更新检查频率](#127-设置自动更新检查频率)
    - [1.2.8. 手动更新](#128-手动更新)
    - [1.2.9. 查看执行日志](#129-查看执行日志)
...
--schedule, -s - 设置定时检测更新时间。格式为 6 字段 Cron 表达式，而非传统的 5 字段，即第一位是秒。比如每天1 点检查一次更新：
