...
```shell
set INFLUX_TOKEN=token字符串
set INFLUX_ORG=org名(可通过命令influx.exe org list获取)
# 删除指定时间段数据
influx.exe delete --bucket "FeiMaLog" --start "2020-01-01T00:00:00Z" --stop "2025-12-31T23:59:59Z" 
```
