...
- [3. 分类小计等](#3-分类小计等)
  - [3.1. 应用一](#31-应用一)
  - [3.2. 应用二](#32-应用二)
- [4. LEAD和LAG函数](#4-lead和lag函数)
  - [4.1. LAG函数](#41-lag函数)
    - [4.1.1. 语法](#411-语法)
    - [4.1.2. 参数解释](#412-参数解释)
    - [4.1.3. 示例](#413-示例)
  - [4.2. LEAD函数](#42-lead函数)
- [5. WITH CUBE语句](#5-with-cube语句)
- [6. 根据数量字段将一条拆成多条](#6-根据数量字段将一条拆成多条)
- [7. 快速创建一个有2048*2048条数据的表](#7-快速创建一个有20482048条数据的表)
- [8. 生成任意数量序列数据（从0开始）](#8-生成任意数量序列数据从0开始)
- [9. 字符串格式化](#9-字符串格式化)
- [10. 查询所有表字段](#10-查询所有表字段)
